 ...
 */
@JsonPropertyOrder({
  KafkaRequestList.JSON_PROPERTY_KIND,
  KafkaRequestList.JSON_PROPERTY_PAGE,
  KafkaRequestList.JSON_PROPERTY_SIZE,
  KafkaRequestList.JSON_PROPERTY_TOTAL,
  KafkaRequestList.JSON_PROPERTY_ITEMS
})
@JsonTypeName("KafkaRequestList")
...
public class KafkaRequestList {
  ...
  private List<KafkaRequest> items = new ArrayList<KafkaRequest>();
